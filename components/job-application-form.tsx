...
export function JobApplicationForm({ isOpen, onClose, onGoBack, job, searchLocation }: JobApplicationFormProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose} className="z-[99999]">
      <DialogContent className="w-full h-full max-w-none max-h-none m-0 p-0 bg-background md:max-w-2xl md:max-h-[90vh] md:m-auto md:rounded-3xl overflow-y-auto z-[99999] [&>button]:absolute [&>button]:right-6 [&>button]:text-[#1E4D47]">
