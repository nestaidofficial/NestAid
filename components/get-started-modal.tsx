...
type Step = "initial" | "jobs" | "care" | "services" | "who_needs_care" | "form"
          ...
          {jobCategories.map((category, index) => {
            ...
            return (
              <div key={category.id}>
                <Button
                  asChild
                  className="w-full p-6 text-center text-black text-lg font-medium bg-white hover:bg-gray-50 border border-gray-200 hover:border-gray-300 rounded-2xl transition-all duration-200 h-auto relative"
                >
