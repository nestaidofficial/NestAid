            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center min-h-screen py-12 md:py-16">
              ...
              <div className="relative flex items-center justify-center md:justify-end" data-aos="fade-left">
                <div className="relative w-full max-w-md md:max-w-lg">
                  ...
                  {/* Social Media Icons - Right Edge - Hidden on mobile to prevent overflow */}
                  <div className="hidden md:flex absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-12 flex-col gap-4 z-10">
                  ...
                  <div className="absolute right-0 top-0 bottom-0 w-px bg-[#E8E8E8] translate-x-14 hidden md:block"></div>
                </div>
              </div>
            </div>
          </div>
