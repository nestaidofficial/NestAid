...
import { 
  ...
  FileText, Home, MapPin, GraduationCap,
  ...
  const processSteps = [
    {
      ...
      description: "Nestaid evaluates if you and your loved one qualify under Medicaid rules.",
      icon: CheckCircle
    },
    {
      number: "2", 
      title: "Application Assistance",
      description: "We complete and file the paperwork with your state program.",
      icon: FileText
    },
    {
      number: "3",
      title: "Home Care Assessment",
      description: "A nurse visits to confirm your loved one's care needs and design a care plan.",
      icon: Home
    },
    {
      number: "4",
      title: "Enrollment & Training",
      description: "You're officially recognized as a caregiver and receive caregiver orientation.",
      icon: GraduationCap
    },
    {
      number: "5",
      title: "Start Receiving Pay",
      description: "Compensation begins once approval is finalized (typically 30–60 days).",
      icon: DollarSign
    }
  ]
      ...
      <section className="relative overflow-x-hidden bg-white">
          ...
          <div className="container mx-auto px-16 py-32">
            <div className="flex items-start gap-12 max-w-7xl mx-auto">
              ...
              <div className="flex-[1] space-y-8">
                ...
                <div className="bg-[#4a7c59] rounded-[3.5rem] p-10 h-[350px] w-full flex flex-col justify-center">
        ...
        <div className="lg:hidden">
          <div className="container mx-auto px-6 py-20">
            ...
            {/* Content Box */}
            <div className="bg-[#4a7c59] rounded-[3.5rem] p-8 h-[300px] w-full flex flex-col justify-center">
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-12">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-5xl font-serif font-bold text-white mb-4">
              Becoming a Paid Family Caregiver is Simple
            </h2>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mt-12">
                      <Button 
                        size="lg" 
                className="bg-[#16803C] hover:bg-[#1f4a37] text-white font-bold text-lg px-8 py-4 rounded-full transition-all duration-400 shadow-lg hover:shadow-xl transform hover:scale-105"
                onClick={() => setShowEligibilityModal(true)}
                      >
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {successStories.map((story, index) => (
              <Card key={story.name} className="bg-white border-2 border-[#E4F2D4] hover:shadow-lg transition-shadow">
      ...
      <section className="py-16 md:py-24 bg-white overflow-x-hidden">
        <div className="container mx-auto px-4 md:px-6 lg:px-12">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg text-[#1A5463] max-w-4xl mx-auto leading-relaxed">
              Caregiver compensation programs are funded by state Medicaid plans, and eligibility rules vary. Nestaid currently serves families in:
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              {availableStates.map((state, index) => (
                <div key={state} className="bg-[#FCFDFB] rounded-3xl p-6 text-center shadow-sm hover:shadow-lg transition-shadow cursor-pointer group border border-[#E4F2D4]">
                  <div className="w-12 h-12 rounded-full bg-[#E4F2D4] flex items-center justify-center mx-auto mb-4 group-hover:bg-[#275F48] transition-colors">
                    <MapPin className="w-6 h-6 text-[#275F48] group-hover:text-white transition-colors" />
                    </div>
                  <h3 className="text-lg font-bold text-[#1A5463]">{state}</h3>
                </div>
              ))}
            </div>
            
            <div className="text-center space-y-8">
              <p className="text-base text-[#1A5463] font-medium">…and we're expanding soon.</p>
              <Button 
                size="lg" 
                className="bg-[#16803C] hover:bg-[#1f4a37] text-white font-bold text-lg px-8 py-4 rounded-full transition-all duration-400 shadow-lg hover:shadow-xl transform hover:scale-105"
                onClick={() => setShowEligibilityModal(true)}
